...
--
-- Structure de la table `minishop_produits`
--

CREATE TABLE `minishop_produits` (
...
--
-- Contenu de la table `minishop_produits`
--

INSERT INTO `minishop_produits` (`id_produit`, `nom_produit`, `prix_produit`, `image_produit`) VALUES
...
--
-- Index pour la table `minishop_produits`
--
ALTER TABLE `minishop_produits`
...
--
-- AUTO_INCREMENT pour la table `minishop_produits`
--
ALTER TABLE `minishop_produits`
